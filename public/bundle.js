var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", "mi mi-undo svelte-enlhjq");
    			add_location(i, file$1, 27, 0, 522);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, resData = await response.json());
    		console.log(resData);
    	...
    	$$self.$capture_state = () => ({ onMount, Grid: Gridjs, resData, data });
    	...
    	return [resData, data, click_handler];
    }
